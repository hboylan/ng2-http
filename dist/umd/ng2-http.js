(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["RESTClient"] = factory(require("@angular/core"), require("@angular/http"));
	else
		root["RESTClient"] = factory(root["ng"]["core"], root["ng"]["http"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rest_service_1 = __webpack_require__(4);
	/**
	...
	*/
	var RESTClient = /** @class */ (function () {
	    ...
	    RESTClient.prototype.getBaseUrl = function () {
	        if (http_1.Headers)
	            if (http_1.RequestOptions)
	                if (http_1.URLSearchParams)
	    ...
	    */
	    RESTClient.prototype.requestInterceptor = function (req) {
	        return Observable_1.Observable.of(req);
	    };
	    /**
	 ...
	 */
	exports.Path = util_1.param('Path');
	/**
	 * Query value of a method's url, type: string
	 * @param {string} key - query key to bind value
	 */
	exports.Query = util_1.param('Query');
	/**
	 * Body of a REST method, type: key-value pair object
	 * Only one body per method!
	 */
	exports.Body = util_1.param('Body')('Body');
	/**
	 * Custom header of a REST method, type: string
	 * @param {string} key - header key to bind value
	 */
	exports.Header = util_1.param('Header');
	/**
	 * GET method
	 * @param {string} url - resource url of the method
	 */
	exports.GET = util_1.method(http_1.RequestMethod.Get);
	/**
	 * POST method
	 * @param {string} url - resource url of the method
	 */
	exports.POST = util_1.method(http_1.RequestMethod.Post);
	/**
	 * PUT method
	 * @param {string} url - resource url of the method
	 */
	exports.PUT = util_1.method(http_1.RequestMethod.Put);
	/**
	 * DELETE method
	 * @param {string} url - resource url of the method
	 */
	exports.DELETE = util_1.method(http_1.RequestMethod.Delete);
	/**
	 * HEAD method
	 * @param {string} url - resource url of the method
	 */
	exports.HEAD = util_1.method(http_1.RequestMethod.Head);
	/**
	 * PATCH method
	 * @param {string} url - resource url of the method
	 */
	exports.PATCH = util_1.method(http_1.RequestMethod.Patch);
	    ...
	    return function (url) {
	        return function (target, propertyKey, descriptor) {
	            ...
	            descriptor.value = function () {
	                ...
	                return this.requestInterceptor(new http_1.Request(options))
